...
class SppagebuilderAddonDonation extends SppagebuilderAddons {
    ...
    public function render() {
        ...
        $output .= '<a href="#" target="' . $target . '" class="btn btn-primary donation-button-link">' . Text::_('COM_SPPAGEBUILDER_ADDON_DONATE_NOW') . '</a>';
    ...
    public static function getTemplate() {
        $lang = Text::_("COM_SPPAGEBUILDER_ADDON_DONATE_NOW");
        $output = '
                <#
