...
SpAddonsConfig::addonConfig(
        array(
            'type' => 'content',
            'addon_name' => 'sp_pie_progress_custom',
            'title' => JText::_('COM_SPPAGEBUILDER_ADDON_PIE_PROGRESS_CUSTOM'),
            'desc' => JText::_('COM_SPPAGEBUILDER_ADDON_PIE_PROGRESS_CUSTOM_DESC'),
            'category' => 'Content',
            'attr' => array(
                'general' => array(
                    'admin_label' => array(
