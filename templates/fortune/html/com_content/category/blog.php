...
<div class="blog-listing-top-title-wrapper">
	<h3 class="blog-listing-top-title"><?php echo JText::_('COM_CONTENT_AWESOME_STORIES'); ?></h3>
	<h3 class="event-listing-top-title"><?php echo JText::_('COM_CONTENT_UPCOMING_STORIES'); ?></h3>
</div>
		...
		<div class="article-list articles-leading<?php echo $this->params->get('blog_class_leading'); ?>">
			<?php foreach ($this->lead_items as &$item) : ?>
				...
				<div class="article<?php echo $item->state == 0 ? ' system-unpublished' : null; ?>"
					itemprop="blogPost" itemscope itemtype="https://schema.org/BlogPosting" data-reading-time="<?php echo $readingTime; ?>">
						<?php
						$this->item = & $item;
